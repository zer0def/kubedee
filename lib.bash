...
# kata
[ "$(uname -m)" != "x86_64" ] || curl -fsSL https://github.com/kata-containers/kata-containers/releases/download/${kubedee_kata_version}/kata-static-${kubedee_kata_version}-${sys_arch}.tar.xz | tar -xJC /
#[ "$(uname -m)" != "x86_64" ] || curl -fsSL https://github.com/kata-containers/runtime/releases/download/${kubedee_kata_version}/kata-static-${kubedee_kata_version}-${sys_arch}.tar.xz | tar -xJC /
