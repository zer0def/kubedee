...
[Service]
ExecStartPre=/usr/bin/mkdir -p /var/run/kata-containers/shared/sandboxes
ExecStartPre=/usr/bin/mount --bind --make-rshared /var/run/kata-containers/shared/sandboxes /var/run/kata-containers/shared/sandboxes
